    ...
    $message = '
        <html>
            ...
            <body>
                ...
                <p><a href="http://192.168.100.86/~rf429369/project5/logon.php?form=reset&user_id=' . $user['id'] . '">Reset Password</a></p>
            </body>
        </html>
    ';
...
function sendValidationEmail($userId, $name, $emailAddress){
    ...
    <html>
        ...
        <body>
            ...
            <p><a href="http://192.168.100.86/~rf429369/project5/logon.php?action=validate&user_id=' . $userId . '">Validate Email</a></p>
        </body>
    </html>
';
...
function displayLoginForm($message=""){
   ...
   <body>
     ...
     <input type="text" name="username" style="border-radius:10px" /></p>

     <p><label>Password: </label>
     <input type="password" name="password" style="border-radius:10px" /></p>
